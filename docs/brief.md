...
The BMad v6-Powered SDLC Platform Web UI is a comprehensive web-based platform that democratizes BMad-CORE's proven AI-driven agile workflows for non-technical stakeholders while enabling complete upstream SDLC lifecycle orchestration (ideation, planning, solutioning) using BMad Method v6, with seamless handoff to existing BMad v6 IDE workflows for downstream development. The platform addresses the fundamental disconnect where product managers, analysts, and architects create requirements using traditional tools (Word, SharePoint, PowerPoint, Figma) while developers work in IDEs with BMad v6's 12 specialized agents and scale-adaptive intelligence. By implementing BMad-CORE's **C**ollaboration **O**ptimized **R**eflection **E**ngine in an intuitive web interface with native support for business document formats, this platform enables non-technical users to leverage v6's 4-phase workflow structure (Analysis → Planning → Solutioning → Implementation) for upstream activities and 3-track scale-adaptive intelligence (Quick Flow, BMad Method, Brownfield) - generating the complete spectrum of upstream SDLC and business artifacts while maintaining seamless integration with existing BMad v6 IDE workflows and the proven 12-agent orchestration system for downstream development.
...
**Interface Disconnect:** Business stakeholders create specifications in Word documents, Excel spreadsheets, PowerPoint presentations, and Figma designs, while developers need markdown files and code-based artifacts. The lack of accessible document viewing and editing capabilities in web-based platforms creates manual conversion overhead, version control issues, and information loss during handoffs.
...
**2. Intelligent Agent Orchestration System:** Context-aware agent selection and coordination leveraging BMad v6's specialized agents through an intelligent orchestrator with dynamic file-level loading:
   ...
   - **Dynamic File-Level Loading:** Implements MCP tool calling or function calling capabilities to load only specific agent files (individual workflows, specific tasks, targeted agent definitions) as needed, reducing token consumption by 60-70% while maintaining full agent capabilities
...
**4. Document Management & Editing Hub:** Comprehensive web-based document viewing and editing capabilities for BMad v6's markdown-based artifacts, maintaining content fidelity and version synchronization while preserving BMad methodology integrity and enabling seamless collaboration.
...
**6. Seamless BMad v6 Integration Architecture:** Dual-action GitHub synchronization (Save to working branch for iterative work, Publish to merge with main branch including diff visualization) with existing BMad v6 IDE workflows and GitHub repositories, with document storage primarily in Git repositories. Future phase will add accept/reject capabilities for individual diffs during publish. Future SharePoint integration planned through Model Context Protocol (MCPs) for simplified enterprise document management while preserving both native document formats and BMad methodology throughout the complete workflow lifecycle.
...
**Key Differentiators:** Unlike existing project management or documentation tools, this platform specifically implements BMad v6's revolutionary scale-adaptive intelligence and intelligent agent orchestration system with dynamic file-level loading while enabling comprehensive artifact generation for upstream SDLC activities (ideation, planning, solutioning). Non-technical stakeholders can leverage BMad v6's proven 4-phase methodology and contextually-selected specialized agent expertise to orchestrate upstream project delivery - from market research and business case development through technical specifications and planning documentation - using familiar document formats while maintaining seamless integration with existing BMad v6 IDE workflows for downstream development. The intelligent orchestrator with dynamic file-level loading eliminates complexity and token consumption by presenting only relevant agents and specific workflow components, transforming business stakeholders from requirement creators into complete upstream orchestrators powered by BMad v6's AI-driven agile capabilities without cognitive overload.
...
- Comprehensive document viewing and editing capabilities within the web platform
...
- **Intelligent Agent Orchestration Engine:** Context-aware orchestrator that analyzes user requirements and intelligently selects relevant agents from BMad v6's 12-agent ecosystem (PM, Analyst, Architect, Scrum Master, Developer, Test Architect, UX Designer, Technical Writer, Game Designer, Game Developer, Game Architect, BMad Master), presenting only contextually appropriate agents with progressive engagement and dynamic file-level loading (specific workflows, tasks, agent definitions) through MCP tool calling or function calling capabilities to reduce token consumption by 60-70%
- **4-Phase Workflow Implementation:** Full web-based execution of BMad v6's proven methodology for upstream activities (Analysis → Planning → Solutioning) with phase-appropriate artifact generation and stakeholder handoffs, with clear handoff to BMad v6 IDE workflows for Implementation phase
- **Document Viewing & Editing Engine:** Comprehensive web-based document viewing and editing capabilities for BMad v6's markdown-based artifacts, maintaining content structure, formatting, and embedded media while preserving BMad methodology integrity
...
- **Comprehensive Artifact Generation:** Web-based creation of complete project artifact suites for upstream activities following BMad v6's proven templates and workflows, including SDLC documents (requirements, architecture, user stories, test plans), business documents (market research, business cases, presentations), compliance documentation, and training materials with comprehensive editing and version control capabilities
- **Dual-Action GitHub Synchronization:** Bidirectional synchronization with two distinct actions:
...
- **Workspace Management:** Complete workspace (project) orchestration with clear distinction between workspace-level and account-level operations, artifact organization, team member access control, and format-aware collaboration features across BMad v6's upstream SDLC phases
- **Workspace Creation Workflows:** Complete workspace setup for both scenarios:
...
- **BMad v6 Template Library:** Complete BMad v6 artifact template suite covering all project phases, tracks, and document types, with comprehensive editing capabilities and guided workflow execution
- **Ignis Platform Telemetry Integration:** Comprehensive telemetry capture including user interactions, workflow performance, agent utilization (including dynamic file-level loading metrics), document generation metrics, and system performance data with real-time transmission to main Ignis Platform for analytics and optimization

### Environment Initialization (Must Have)

- **Codebase Configuration Setup (Not Project Creation):** Clear distinction between codebase-level configuration (repository setup, integration configuration) and account-level project management, with proper terminology throughout the interface to avoid confusion
...
- **Ignis Platform Configuration:** Mandatory Ignis Platform endpoint configuration, authentication credentials setup, telemetry data schema alignment, and real-time data transmission verification before platform activation
...
- **BMad v6 Workflow Integration:** Agent-guided approval processes following BMad v6's 4-phase methodology for upstream activities, with specialized agent review capabilities (PM review for business artifacts, Architect review for technical specifications, etc.), and phase-appropriate approval workflows
...
- **Dual-Action Publishing Pipeline:** Two distinct user-initiated actions:
  * **Save Action:** Persist artifacts to BMad working branch via GitHub API for iterative work
  * **Publish Action:** Persist artifacts to working branch + merge to main branch via GitHub API with diff visualization (future phase: accept/reject individual diffs), simultaneous publishing to configured SharePoint locations, BMad v6 IDE workflow synchronization, confirmation and audit trail generation, and version synchronization across all publishing destinations
- **Document Lifecycle Management:** Complete workflow from creation through review, approval, and dual-action publishing following BMad v6's proven methodology, with conflict resolution capabilities, backup and recovery systems, comprehensive audit logging for enterprise compliance, and diff visualization for publish operations
...
The MVP will be considered successful when a non-technical product manager can: (1) Complete workspace creation for either Greenfield (GitHub repository creation, user configuration, BMad framework installation, workflow initialization, working branch setup, metadata updates) or Brownfield (existing repository configuration, BMad setup, workflow configuration, working branch creation) within 30 minutes, (2) Create a complete workspace with proper user permissions, collaboration settings, and BMad v6 track selection, (3) Generate a comprehensive artifact suite for upstream activities including market research, business case, PRD, and technical specifications using BMad v6's 4-phase methodology and scale-adaptive intelligence with dynamic file-level agent loading, (4) Import Figma designs and generate design specifications in Word format using BMad v6's UX Designer agent workflows, (5) Collaborate with team members across all artifact types using their preferred document formats with BMad v6 agent-guided editing capabilities, (6) Execute dual-action GitHub workflows (Save to working branch for iterative work, Publish to merge with main branch showing diff visualization), (7) Execute the complete approval workflow with stakeholder review, BMad v6 agent validation, and approval tracking, (8) Successfully publish approved documents via dual-action workflow (Save/Publish) with GitHub synchronization, SharePoint publishing, and BMad v6 IDE workflow integration using MCP, and (9) Hand off the complete upstream documentation suite to development teams who can seamlessly continue Implementation phase in their existing BMad v6 IDE environment. Success is measured by completing this end-to-end workspace creation, artifact generation, dual-action workflow, approval, and publishing process within 6 hours for a typical BMad Method track upstream project (reduced from 8 hours through scale-adaptive intelligence and dynamic file-level loading), with minimal technical support required and full audit trail documentation.
...
- **Performance Requirements:** Sub-2 second page load times, document editing response within 500ms, real-time document synchronization with GitHub within 5 seconds, support for documents up to 50MB with embedded media and designs
...
**Challenge:** BMad v6 agents and workflows are dynamically loaded from repository files (.bmad and .github directories) at the file level (specific workflows, individual tasks, targeted agent definitions) rather than complete agent bundles, requiring sophisticated caching and loading strategies for web implementation to avoid token bloat and performance degradation.

**Solution Components:**
- **Per-Workspace Repository Caching:** Selective cloning and caching of .bmad and .github directories for each workspace with intelligent cache invalidation and background updates
- **Dynamic File-Level Loading:** Context-aware loading of specific agent files (individual workflows, specific tasks, targeted agent definitions) based on project type, current phase, and user requirements through MCP tool calling or function calling capabilities, equivalent to desktop environment tools (createFile, editFile, createDirectory, changes/diff)
- **Token Optimization Strategy:** Intelligent prompt management that balances functionality with performance, using file-level agent component loading and progressive engagement patterns to achieve 60-70% token reduction
- **MCP Tool Integration:** Efficient file reader/writer tool access for dynamic workflow execution with optimized API call patterns, caching mechanisms, and file-level component retrieval
- **Dual-Action Working Branch Strategy:** Save action for frequent updates to working branch; Publish action for merging to main branch with diff visualization (future phase: accept/reject individual diffs)

**Performance Optimization:**
- **File-Level Selective Loading:** Load only specific agent files (workflows, tasks, definitions) relevant to current project context and phase
- **Progressive Engagement:** Start with 2-3 contextually appropriate agents and their required files, dynamically load additional agent components as project complexity evolves
- **Agent Component Repository:** Store agent definitions, workflows, and tasks in workspace-specific repositories for dynamic file-level access
- **Caching Strategy:** Pre-load common agent combinations and workflow definitions with background refresh
- **Token Management:** Optimize prompt size through selective agent definition inclusion and context-aware loading

### Dynamic Phase Progress Tracking Architecture

**Challenge:** Project phases in BMad v6 are dynamically determined by LLM agents updating document status rather than programmatic database updates, requiring sophisticated status tracking mechanisms for web implementation.

**Solution Components:**
- **MCP Status Server:** Dedicated MCP server that agents can call to update phase completion status programmatically
- **Document Status Scanning:** Backend mechanism to scan BMad v6 documents for completion markers and status indicators
- **Phase Extraction Engine:** Dynamic extraction of project phases from workflow definitions based on project type and track selection
- **Real-time Status Polling:** Frequent status updates on user login and after each chat interaction to maintain accurate progress indicators
- **Agent-Driven Updates:** LLM agents call MCP server endpoints to update status when completing tasks or reaching milestones

**Implementation Strategy:**
- **Status API Integration:** RESTful API for phase status management with real-time updates
- **Workflow Definition Parsing:** Extract available phases from BMad v6 workflow definitions dynamically
- **Agent Integration:** Provide MCP tools for agents to update completion status during workflow execution
- **UI Synchronization:** Real-time progress bar updates based on backend status polling and agent updates
...
- **Temporary File Storage:** Dedicated temporary storage for document processing, editing sessions, and collaborative editing with automatic cleanup policies
...
- **Ignis Platform Configuration:** Main Ignis Platform endpoint URL, authentication credentials (API keys, service tokens), telemetry data schema configuration, real-time data transmission settings, and analytics dashboard integration
...
- Rich text editing capabilities with markdown support and real-time preview
...
- **Technical:** Must maintain backward compatibility with existing BMAD framework and VS Code extensions while adding comprehensive document viewing and editing capabilities that maintain content fidelity and BMad v6 methodology integrity
...
- Web-based document viewing and editing capabilities can provide sufficient functionality for business-critical content including formatting, tables, images, and embedded media while preserving BMad v6 methodology integrity
...
- **Performance Scalability:** Comprehensive artifact processing, document editing operations, and BMad v6 workflow orchestration may create performance bottlenecks as project complexity, artifact volume, and user base increase
...
- Should the platform support offline functionality for comprehensive artifact editing across all document types while maintaining BMad v6 workflow continuity?
...
- **Agent-as-Code Performance Optimization:** Token consumption analysis for different agent loading strategies, latency benchmarking for dynamic workflow execution, and caching effectiveness for agent definitions
- **Dynamic Phase Progress Implementation:** MCP server architecture design, document status scanning algorithms, and real-time UI synchronization performance
...
Initial assessment confirms that existing BMad v6 framework components can be adapted for web-based implementation while maintaining methodology integrity, with GitHub API providing sufficient capabilities for bidirectional synchronization with existing IDE workflows. Web-based document editing technology evaluation shows promising results for maintaining content fidelity and functionality while preserving BMad v6 template structure and agent-specific content.

### B. Stakeholder Input

**Development Team Feedback:** Team members have expressed confidence in adapting existing BMad v6 workflows to web interfaces while maintaining methodology integrity, scale-adaptive intelligence, and compatibility with existing IDE workflows. Additional technical complexity of document editing capabilities and BMad v6 integration is acknowledged but considered manageable given the proven framework foundation.
...
2. **Conduct BMad v6 Agent-as-Code Technical Deep Dive** including whiteboarding session for dynamic loading architecture, performance benchmarking for token consumption, MCP tool integration strategy, and phase progress tracking implementation
3. **Assess comprehensive document editing technologies** including rich text editors, markdown processors, and template generation systems for functionality and performance across all artifact types while preserving BMad v6 methodology structure
...
6. **Assess Ignis Platform integration requirements** including telemetry data schema, API endpoints, authentication mechanisms, real-time data transmission protocols, and analytics dashboard integration specifications
7. **Develop competitive analysis** of existing project management and documentation platforms with focus on AI-driven methodologies, comprehensive artifact generation, and multi-format support capabilities compared to BMad v6's proven approach

### PM Handoff

This Project Brief provides the full context for BMad v6-Powered SDLC Platform Web UI with comprehensive artifact generation, scale-adaptive intelligence, document viewing/editing capabilities, and Ignis Platform telemetry integration. Please start in 'PRD Generation Mode', review the brief thoroughly to work with the user to create the PRD section by section as the template indicates, asking for any necessary clarification or suggesting improvements. Pay particular attention to BMad v6's scale-adaptive intelligence implementation, intelligent agent orchestration system, 4-phase methodology execution, comprehensive artifact generation requirements, BMad v6 IDE integration requirements, document viewing and editing capabilities, Ignis Platform telemetry integration requirements, and their impact on user workflows and technical architecture.
